...
import lux.pe.na.store.validation.ResponseError;
import lux.pe.na.store.validation.ResponseMapper;
...
public class GlobalResponse extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ValidNotFoundException.class)
    public ResponseEntity<Object> handleResourceNotFoundException(ValidNotFoundException ex) {
